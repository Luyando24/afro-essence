      ...
      <header className="sticky top-0 z-40 bg-white border-b border-gray-100 shadow-sm">
        ...
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <span className="text-[10px] text-primary font-bold uppercase tracking-wider">Afro Essence Admin</span>
              <h1 className="text-xl font-serif font-bold text-gray-950">Publish Luxury Extension</h1>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. Afro Kinky Curly Bundle"
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Provide details about cuticle alignment, natural hair color grades, processing, extensions care, etc..."
                    rows={4}
